...
CREATE TABLE
    IF NOT EXISTS exibicao_reservas (
        ...
        id_exibicao_laboratorio INTEGER NOT NULL,
        ...
        CONSTRAINT exibicao_reservas_ibfk_1 FOREIGN KEY (id_exibicao_laboratorio) REFERENCES laboratorios (id_laboratorio),
        CONSTRAINT exibicao_reservas_ibfk_2 FOREIGN KEY (id_exibicao_aula) REFERENCES aulas_ativas (id_aula_ativa),
        CONSTRAINT uq_exibicao_lab_aula_dia UNIQUE (
